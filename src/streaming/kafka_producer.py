    ...
    def _init_producer(self):
        ...
        try:
            ...
            self.producer = KafkaProducer(
                ...
                max_in_flight_requests_per_connection=kafka_config.PRODUCER_CONFIG["max_in_flight_requests_per_connection"],
    ...
    def send_message(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if self.stats["messages_sent"] % 100 == 0:
                logger.info(
                    f"📤 Messages envoyés: {self.stats['messages_sent']} | "
                    f"Topic: {topic} | Pair: {trading_pair}"
                )
