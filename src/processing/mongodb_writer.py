...
def write_to_mongodb_batch(df: DataFrame, collection: str, mode: str = "append") -> None:
    """
...
def write_to_console(df: DataFrame, truncate: bool = False, num_rows: int = 20) -> StreamingQuery:
    """
...
def get_query_status(query: StreamingQuery) -> dict:
    ...
    return {"id": query.id, "name": query.name, "is_active": query.isActive, "recent_progress": query.recentProgress}
